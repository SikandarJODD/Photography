...
<form>
	<div class="space-y-12 bg-gray-50 dark:bg-gray-950">
		<div class="border-b border-white/10 pb-12">
			<h2 class="text-base lg:text-xl font-semibold lg:font-bold leading-7 text-white">
				Edit Profile
			</h2>
			<p class="mt-1 text-sm leading-6 text-gray-400">
				Update Your Profile & Get to be <span class="text-gray-200">Known</span>
			</p>
			...
			<div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
				...
				<div class="col-span-full">
					<label for="cover-photo" class="block text-sm font-medium leading-6 text-white"
						>Cover photo</label
					>
					<div
		...
		<div class="border-b border-white/10 pb-12">
			...
			<div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
				...
				<div class="col-span-full">
					<label for="street-address" class="block text-sm font-medium leading-6 text-white"
				...
				<div class="sm:col-span-2">
					<label for="region" class="block text-sm font-medium leading-6 text-white"
				...
				<div class="sm:col-span-2">
					<label for="postal-code" class="block text-sm font-medium leading-6 text-white"
				...
				<fieldset>
					...
					<div class="mt-6 space-y-6">
						<div class="flex items-center gap-x-3">
							...
							/>
							<label for="push-everything" class="block text-sm font-medium leading-6 text-white"
								>Everything</label
							>
						</div>
						<div class="flex items-center gap-x-3">
							<input
								...
								class="h-4 w-4 border-white/10 bg-white/5 text-indigo-600 focus:ring-indigo-600 focus:ring-offset-gray-900"
							/>
							<label for="push-email" class="block text-sm font-medium leading-6 text-white"
								>Same as email</label
							>
						</div>
						<div class="flex items-center gap-x-3">
							<input
								...
								class="h-4 w-4 border-white/10 bg-white/5 text-indigo-600 focus:ring-indigo-600 focus:ring-offset-gray-900"
							/>
							<label for="push-nothing" class="block text-sm font-medium leading-6 text-white"
